...
# @url https://core.telegram.org/bots/api#animation# ['This object represents an animation file (GIF or H.264/MPEG-4 AVC video without sound).']
...
class Animation(DefaultType):
    ...
    # @var thumb Optional. Animation thumbnail as defined by sender

    @property
    def thumb(self) -> PhotoSize:
        return self._d["thumb"]
    # @var file_name Optional. Original animation filename as defined by sender
