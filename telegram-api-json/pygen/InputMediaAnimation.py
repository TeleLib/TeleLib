...
# @url https://core.telegram.org/bots/api#inputmediaanimation# ['Represents an animation file (GIF or H.264/MPEG-4 AVC video without sound) to be sent.']
class InputMediaAnimation(DefaultType):

    
	# @var type Type of the result, must be animation
	@property
	...
	# @var caption Optional. Caption of the animation to be sent, 0-1024 characters after entities parsing
	@property
	def caption(self) -> String:
		return self._d["caption"]
	# @var parse_mode Optional. Mode for parsing entities in the animation caption. See formatting options for more details.
	@property
	...
	# @var width Optional. Animation width
	@property
	def width(self) -> Integer:
		return self._d["width"]
	# @var height Optional. Animation height
	@property
	def height(self) -> Integer:
		return self._d["height"]
	# @var duration Optional. Animation duration in seconds
	@property
